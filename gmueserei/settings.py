...
DEBUG = True
# os.environ.get("JUNTAGRICO_DEBUG", "False") == "True"


ALLOWED_HOSTS = ["mini.gmueserei.ch", "localhost", "127.0.0.1"]


ADMINS = (("Admin", os.environ.get("JUNTAGRICO_ADMIN_EMAIL")),)
MANAGERS = ADMINS
...
DATABASES = {
    "default": {
        ...
        "USER": "juntagrico",
        #  os.environ.get('JUNTAGRICO_DATABASE_USER'), #''junatagrico', # The following settings are not used with sqlite3:
...
ORGANISATION_ADDRESS = {
    "name": "Genossenschaft GMÜESEREI SISSACH",
    "street": "Ebenrainweg",
    "number": "25e",
    "zip": "4450",
    "city": "Sissach",
